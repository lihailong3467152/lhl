...
- **持续进化**：紧跟 GPT-6/DeepSeek 等大模型生态及 FastAPI 异步架构。
...
PDF 批量工具：政府网站下载专用：针对特定站点优化的下载逻辑。  
智能重命名：根据 PDF 内部正文内容自动命名文件。  
政务消费监测：针对新余市统计局、商务局数据的专项采集。  
...
```
## <a id="🚀-快速开始"></a>🚀 快速开始
 获取代码Bashgit clone [https://github.com/lihailong3467152/vscode-repository.git](https://github.com/lihailong3467152/vscode-repository.git)
cd vscode-repository
 环境配置Bash# 安装依赖
